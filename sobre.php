...
<section class="sobre-hero">
    ...
    <div class="sobre-hero-onda">
        <svg viewBox="0 0 1440 72" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" width="100%" height="72">
            <path d="M0,0 C480,72 960,0 1440,48 L1440,72 L0,72 Z" fill="#fdf6e8" />
        </svg>
    </div>
</section>

<!-- ===== QUEM SOMOS ===== -->
<section class="sobre-quem">
    <div class="sobre-container">
        <div class="quem-grid">
            ...
            <div class="quem-visual">
                <div class="quem-img-wrap">
                    <img src="./img/imagemcentrodecond.jpg" alt="Condomínio">
...
<section class="sobre-mvv">
    <div class="sobre-container">
        <div class="mvv-header">
            <span class="subtag-escuro">O que nos guia</span>
...
<section class="sobre-como">
    <div class="sobre-container">
        <div class="como-header">
            <span class="subtag-claro">Simples e rápido</span>
            <h2>Como funciona</h2>
            <p>Encontre o profissional ideal em poucos passos, sem complicação.</p>
        </div>
        <div class="como-passos">

            <div class="passo-item">
                <div class="passo-num">01</div>
            ...
            <div class="passo-item">
                <div class="passo-num">04</div>
                <div class="passo-icone">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                        <polyline points="20,6 9,17 4,12" />
                    </svg>
                </div>
                <h4>Avalie e colabore</h4>
