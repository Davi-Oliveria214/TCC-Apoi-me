...
<div class="contentAdm">
  ...
  <div class="containerPerfil">
    ...
    <div class="cardPerfil">
      ...
      <div class="actions">
        <button class="btnPerfil btn-ghostPerfil" onclick="resetField('username','joaosilva'); resetField('fullname','João da Silva')">Cancelar</button>
    ...
    <div class="cardPerfil">
      ...
      <div class="fieldPerfil">
        <label for="emailConfirm">Confirmar novo e-mail</label>
        <div class="input-wrap">
      ...
      <div class="cardPerfil">
        ...
        <div class="fieldPerfil">
          <label for="currentPw">Senha atual</label>
          <div class="input-wrap">
        ...
        <div class="fieldPerfil">
          <label for="confirmPw">Confirmar nova senha</label>
          <div class="input-wrap">
